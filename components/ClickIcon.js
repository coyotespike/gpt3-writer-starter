...
const StyledClickIcon = styled.span.attrs((props) => ({
  className: `click-icon ${props.isOpened ? "is-hidden" : ""}`,
}))``;

export const ClickIcon = ({ isOpened }) => (
  <StyledClickIcon isOpened={isOpened}>
